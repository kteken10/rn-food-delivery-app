 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.react_native_hotelgo.staging
 */

// TODO: Replace these values with your own

const BUNDLE_ID = 'com.react_native_hotelgo'; // ios bundle id
const PACKAGE = 'com.react_native_hotelgo'; // android package name
const NAME = 'react_native_hotelGo'; // app name
const EXPO_ACCOUNT_OWNER = 'expo-owner'; // expo account owner
const EAS_PROJECT_ID = 'c3e1075b-6fe7-4686-aa49-35b46a229044'; // eas project id
const SCHEME = 'react_native_hotelGo'; // app scheme
